# Facebook Auto Poster v5.2 Production Edition
...
6. Open **Actions → Facebook Auto Poster v5.2 → Run workflow**.
...
## v5.2 image reliability fix

v5.2 no longer fails when search engines or software websites block image scraping. It first tries Wikipedia and configured software sources. If no valid remote image is available, it automatically generates a clean 1200×630 software title card and uploads that JPEG directly to Facebook. Text-only fallback remains disabled.
